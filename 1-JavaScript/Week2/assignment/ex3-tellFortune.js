...
function main() {
  ...
  const partnerNames = ['Jordan', 'Johannes', 'Sam', 'Alex', 'Tony'];

  const locations = ['Tokyo', 'London', 'Paris', 'Amsterdam', 'Berlin'];

  const jobTitles = ['teacher', 'doctor', 'engineer', 'lawyer', 'programmer'];
